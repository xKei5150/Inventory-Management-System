...
<?php include_once('../include/banner.php'); ?>
  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid navbar-custom">
 	  ...
 	  <ul class="nav navbar-nav">
        ...
        <li>
  	    ...
  	    <li>
          <a href="report.php"><i class="fa-solid fa-clipboard-list"></i></span> Report</a>
        </li>
                <li>
	...
	<div id="right_content" >
        ...
        Item - Equipment/Furniture and Fixture
        </div>
  	  			<div class="panel-body">
  	  			    <button id="addItem" href="#modal-add-item" style="float: right;" class="btn btn-danger mb-2"   data-toggle="modal">
